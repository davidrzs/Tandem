...
const PATHS = {
  ...
  download: "M8 2.8v7.2M5 7 8 10 11 7M3.5 13h9",
  ...
  settings:
    "M3 5.5h5M11.5 5.5H13M3 10.5h1.5M7.5 10.5H13M10 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM5.5 9a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3Z",
  ...
  info: "M8 2.6a5.4 5.4 0 1 0 0 10.8 5.4 5.4 0 0 0 0-10.8ZM8 7.4v3.4M8 5.2h.01",
  alert: "M8 2.9 13.8 12.7H2.2L8 2.9ZM8 6.6v2.9M8 11.2h.01",
  star: "M8 2.6l1.7 3.5 3.8.55-2.75 2.68.65 3.77L8 11.3l-3.4 1.8.65-3.77L2.5 6.65l3.8-.55L8 2.6Z",
  moon: "M13.2 9.6A5.6 5.6 0 0 1 6.4 2.8a5.6 5.6 0 1 0 6.8 6.8Z",
  menu: "M2.5 4.5h11M2.5 8h11M2.5 11.5h11",
  bell: "M12.2 10.8H3.8c.9-.9 1.2-1.6 1.2-3.3 0-2 1.2-3.6 3-3.6s3 1.6 3 3.6c0 1.7.3 2.4 1.2 3.3ZM6.8 12.7a1.3 1.3 0 0 0 2.4 0",
  sun: "M8 5.4a2.6 2.6 0 1 0 0 5.2 2.6 2.6 0 0 0 0-5.2ZM8 2v1.4M8 12.6V14M2 8h1.4M12.6 8H14M3.8 3.8l1 1M11.2 11.2l1 1M12.2 3.8l-1 1M4.8 11.2l-1 1",
} as const;
